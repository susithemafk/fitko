...
const Form = () => {
    ...
    const submitSurvey = api.survey.submit.useMutation({
        onSuccess: () => {
            ...
            toast.success("Díky! Sleva je na cestě do tvé emailové schránky.")
        },
        onError: (error) => {
            ...
            toast.error("Zadaný email byl již použit pro získání slevy.")
        },
    })
    ...
    return (
        <UIForm {...form}>
            <form
                ...
                className="flex flex-row gap-6 items-center max-w-5xl mx-auto justify-center px-4">
                <div className="flex flex-col">
                    <p className="text-2xl font-semibold mb-4">cvičíš radši v soukromí nebo ve fitku?</p>

                    <div className="flex gap-6 justify-center lg:justify-start mb-12 lg:-ml-32">
                        <FormField
                        ...
                        <svg width="64" height="76" viewBox="0 0 64 76" fill="none" xmlns="http://www.w3.org/2000/svg" className="hidden lg:block">
                            <path
                    ...
                    <div ref={machineContainerRef} className="mb-16 lg:mb-30">
